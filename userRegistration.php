...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a class="active" href="userRegistration.php">Registration</a></li>
				...
				<form class="form-horizontal" action="insertDB.php" method="post" >
					<div class="control-group">
						...
						<div class="controls">
                            ...
                            <!-- <input name="id" id="getUID" placeholder="Please Tag your Card / Key Chain to display ID" required type="text"> -->
						</div>
					</div>
